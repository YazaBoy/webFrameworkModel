...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('films.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <textarea name="sinopsis" id="sinopsis" class="w-full p-2 border border-gray-300 rounded-lg" required></textarea>
        </div>
        <div class="mb-4">
            <label for="poster" class="block text-gray-700">Poster</label>
            <input type="file" name="poster" id="poster" class="w-full p-2 border border-gray-300 rounded-lg" required onchange="previewImage(event)">
            <img id="poster-preview" class="h-16 w-auto mt-2" style="display: none;">
        </div>
        <div class="mb-4">
            <label for="tahun" class="block text-gray-700">Year</label>
            <input type="text" name="tahun" id="tahun" class="w-full p-2 border border-gray-300 rounded-lg" required>
        </div>
        <div class="mb-4">
